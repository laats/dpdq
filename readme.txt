...
given as an example below. A more sophisticated example, can be seen in
the complete module that implements a new query type that implements
...
be answered, and one to query a users risk information.
